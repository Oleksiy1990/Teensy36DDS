...
class AD9954
{
  public:
    ...
    void linearSweep(float freq0, float freq1, float posTimeMicros, float negTimeMicros, float waitingTimeMicros, float powerPercentage, byte mode, bool noDwell = true);
